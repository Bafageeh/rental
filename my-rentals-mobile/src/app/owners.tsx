          ...
          <View key={owner.id} style={styles.card}>
            <View style={styles.cardHeaderRow}>
              <View style={styles.cardActions}>
                <TouchableOpacity style={styles.ownerMenuButton} activeOpacity={0.85} onPress={() => setOpenMenuOwnerId(openMenuOwnerId === owner.id ? null : owner.id)}><Ionicons name="ellipsis-vertical" size={19} color="#0F172A" /></TouchableOpacity>
              ...
              <TouchableOpacity style={styles.ownerIdentity} activeOpacity={0.9} onPress={() => openOwnerDetails(owner)}>
                <View style={styles.ownerIconCircle}><Ionicons name="person-outline" size={20} color="#0F766E" /></View>
...
const styles = StyleSheet.create({
  ...
  container: { paddingHorizontal: 12, paddingTop: 6, paddingBottom: 44 },
  ...
  card: { backgroundColor: "#fff", borderRadius: 20, padding: 10, marginBottom: 8, borderWidth: 1, borderColor: "#E6EEE9", shadowColor: "#000", shadowOpacity: 0.04, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 1, position: "relative" },
  cardHeaderRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8, marginBottom: 8 },
  cardActions: { flexDirection: "row", gap: 6, alignItems: "center" },
  ownerMenuButton: { width: 34, height: 34, borderRadius: 17, backgroundColor: "#F8FAFC", borderWidth: 1, borderColor: "#E5E7EB", alignItems: "center", justifyContent: "center", zIndex: 12 },
  accountButton: { width: 34, height: 34, borderRadius: 17, backgroundColor: "#ECFDF5", borderWidth: 1, borderColor: "#A7F3D0", alignItems: "center", justifyContent: "center", zIndex: 12 },
  ownerMenu: { position: "absolute", left: 10, top: 49, width: 150, backgroundColor: "#fff", borderRadius: 16, borderWidth: 1, borderColor: "#E5E7EB", paddingVertical: 5, zIndex: 20, shadowColor: "#0F172A", shadowOpacity: 0.16, shadowRadius: 14, shadowOffset: { width: 0, height: 7 }, elevation: 8 },
  ...
  ownerIdentity: { flex: 1, minWidth: 0, flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  ownerIconCircle: { width: 38, height: 38, borderRadius: 16, backgroundColor: "#ECFDF5", borderWidth: 1, borderColor: "#A7F3D0", alignItems: "center", justifyContent: "center" },
  titleWrap: { flex: 1, minWidth: 0, alignItems: "flex-end" },
  cardTitle: { fontSize: 18, lineHeight: 24, fontWeight: "900", color: "#111827", textAlign: "right" },
  metricsRow: { flexDirection: "row-reverse", gap: 6, marginBottom: 7 },
  metricPill: { flex: 1, backgroundColor: "#FBFCFC", borderWidth: 1, borderColor: "#E6EEE9", borderRadius: 14, paddingVertical: 6, paddingHorizontal: 5, alignItems: "center", justifyContent: "center", minHeight: 58 },
  metricIconBox: { width: 24, height: 24, borderRadius: 10, backgroundColor: "#ECFDF5", alignItems: "center", justifyContent: "center", marginBottom: 1 },
  metricValue: { color: "#111827", fontWeight: "900", fontSize: 15, lineHeight: 18 },
  metricLabel: { color: "#6B7280", fontWeight: "800", fontSize: 10, lineHeight: 13 },
  infoBox: { gap: 6 },
  primaryInfoRow: { flexDirection: "row-reverse", gap: 6 },
  infoChip: { flex: 1, minHeight: 34, backgroundColor: "#FAFAF9", borderRadius: 12, borderWidth: 1, borderColor: "#E6EEE9", paddingHorizontal: 7, flexDirection: "row-reverse", alignItems: "center", gap: 5 },
  infoChipWide: { width: "100%", flex: 0 },
  infoIconBox: { width: 24, height: 24, borderRadius: 10, backgroundColor: "#ECFDF5", alignItems: "center", justifyContent: "center" },
  infoChipText: { flex: 1, color: "#374151", textAlign: "right", fontWeight: "800", fontSize: 11 },
});
...
export default function PropertyFormScreen() {
  const params = useLocalSearchParams<{ id?: string; owner_id?: string; property_type?: string; lock_property_type?: string; source_property_name?: string }>();

...
- تحسين بطاقة تفاصيل العقد ونقل إجراءات التعديل والحذف إلى الشريط العلوي.
- إضافة خط زمني أوضح للدفعات والمدفوع والمتأخر.
- تلوين بطاقات الوحدات حسب حالة العقد وإجراء المستأجر بعد انتهاء العقد.
- إضافة متابعة يومية للعقود المنتهية وتحسين تجربة التحرير ولوحة المفاتيح.
- تحسينات عامة على الثبات وتجربة الاستخدام.
